...
struct SidebarView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            Text("Chats for this project will be deleted only from Dexora on this phone. Nothing is removed from your computer or Codex observer.")
        }
        .alert(
            ...
            Text("This only removes the chat from Dexora on this phone. Nothing is removed from your computer or Codex observer.")
        }
        .alert(
            "Action failed",
            isPresented: Binding(
