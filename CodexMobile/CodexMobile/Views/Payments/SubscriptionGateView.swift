...
// Purpose: Locked shell shown before app access when Dexora Pro is required.
// Layer: View
...
private let subscriptionGateFeatures: [SubscriptionGateFeature] = [
    ...
    .init(id: 7, icon: "heart", title: "Support development", subtitle: "Help keep Dexora independent and open source"),
]
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 10) {
                        ...
                        Text("Dexora couldn’t confirm your Pro access yet. Check your connection, retry, or restore your App Store purchases.")
                            .font(AppFont.caption())
                            .foregroundStyle(secondaryTextColor)
                            .multilineTextAlignment(.center)
                            .lineSpacing(3)
        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    Text("Dexora connects to Codex running on your computer. Buying Pro unlocks the app, but you still need Codex already logged in on that computer.")
                        .font(AppFont.body())
