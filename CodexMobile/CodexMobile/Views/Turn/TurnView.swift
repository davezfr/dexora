    ...
    private func buildVoiceRecoveryPresentation(for reason: CodexVoiceFailureReason) -> VoiceRecoveryPresentation {
        ...
        case .reconnectRequired:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    ...
                    detail: "Keep the bridge running on your paired computer, then try the microphone again.",
                    status: .interrupted,
        ...
        case .bridgeSessionUnsupported:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    ...
                    detail: "Restart the bridge on your computer, then reconnect this iPhone. If it still happens, update the bridge package and pair again.",
        ...
        case .microphonePermissionRequired:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    title: "Voice Mode",
                    summary: "Microphone access is off for Dexora.",
                    detail: "Open iPhone Settings, allow Microphone for Dexora, then try recording again.",
                    status: .actionRequired,
        ...
        case .recorderUnavailable:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    title: "Voice Mode",
                    summary: "Dexora could not start the recorder.",
