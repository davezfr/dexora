...
struct QRScannerView: View {
        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                if let command = prompt.command, !command.isEmpty {
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Bridge", detail: command, showsCopyButton: true)
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Dexora", detail: "Install the latest Dexora build on this iPhone.")
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan the Dexora bridge QR code")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update the bridge on your computer before scanning",
        message: "This QR code was generated by a different bridge version. Update the package on your computer to the latest release before scanning a new QR code.",
...
private final class QRCameraLifecycleCoordinator {
    ...
    private let queue = DispatchQueue(label: "com.dexora.qr-camera.lifecycle")
