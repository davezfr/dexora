...
struct OnboardingView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 0) {
                TabView(selection: $currentPage) {
                    ...
                    OnboardingStepPage(
                        ...
                        description: "The AI coding agent that lives in your terminal. Dexora connects to it from your iPhone.",
                    ...
                    OnboardingStepPage(
                        ...
                        description: "A lightweight bridge that securely connects your Mac to your iPhone.",
                        command: "npm install -g remodex@latest",
                        commandCaption: "Dexora can keep your Mac awake with macOS caffeinate while the bridge is running, but it starts disabled by default. You can enable it later in Settings if you want."
                    )
                    .tag(3)
        ...
        .alert("Install Codex CLI First", isPresented: $isShowingCodexInstallReminder) {
            ...
            Text("Copy and paste \"\(codexInstallCommand)\" on your computer before moving on. Dexora will not work until Codex CLI is installed and available in your PATH.")
        }
    }
