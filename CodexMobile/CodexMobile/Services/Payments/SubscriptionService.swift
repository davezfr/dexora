...
// Depends on: Foundation, Observation, RevenueCat in hosted builds
// Modified for Dexora self-host beta: SELF_HOSTED builds bypass the hosted monetization gate.
...
struct SubscriptionPackageOption: Identifiable {
    ...
    var callToActionTitle: String {
        isLifetime ? "Unlock Lifetime" : "Unlock Dexora Pro"
    }
