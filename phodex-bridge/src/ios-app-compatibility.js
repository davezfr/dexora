...
function buildLegacyIOSAppCompatibilityMessage({
  ...
  return `Dexora bridge ${normalizedBridgeVersion} requires Dexora iPhone `
...
function buildCachedIOSAppCompatibilityWarning({
  ...
  return formatNoticeBox({
    title: "!!! WARNING !!!",
    lines: [
      `Dexora bridge ${snapshot.bridgeVersion || "latest"} requires Dexora iPhone ${snapshot.minimumSupportedIOSAppVersion} or later.`,
